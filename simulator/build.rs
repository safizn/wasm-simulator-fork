...
fn main(){
    ...
    let modules = vec![
        ...
        "sim_modules/wasm_bincode/wasm_bincode_gdsize", "sim_modules/wasm_pair/wasm_pair_gdsize",
        "sim_modules/wasm_bincode/wasm_bincode_lfu", "sim_modules/wasm_pair/wasm_pair_lfu",
        "sim_modules/wasm_bincode/wasm_bincode_lru", "sim_modules/wasm_pair/wasm_pair_lru",
    ];
